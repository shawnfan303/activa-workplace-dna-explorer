    ...
    <article className="overflow-hidden border border-aurora-line bg-white">
      <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="border-b border-aurora-line bg-aurora-soft lg:border-b-0 lg:border-r">
          <img className="h-full min-h-[280px] w-full object-contain" src={assetPath(`/images/scenes/${scene.id}.webp`)} alt={scene.title} loading="lazy" />
        </div>
        <div className="p-6">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-aurora-ink">{scene.title}</h2>
